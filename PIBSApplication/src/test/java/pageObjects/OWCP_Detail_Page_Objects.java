...
public class OWCP_Detail_Page_Objects {

	@FindBy(xpath = "//a[@title='Details']")
	public static WebElement OWCPAction;
	
	/////////////////// Header /////////////////////////////////////////
	
	@FindBy(xpath = "//*[@id='formMedicareOwcpFactorScheduleEdit_ID']/div[1]/a")
	public static WebElement OWCPheader;
	
	@FindBy(xpath = "//*[@id='formMedicareOwcpFactorScheduleEdit_ID']/div[2]/a")
	public static WebElement OWCPCPTFactorheader;
